...
/home/dtiezzi/Softwares/gatk-4.1.6.0/gatk --java-options "-XX:+UseSerialGC -Xmx3G" LearnReadOrientationModel -I f1r2/f1r2.tar.gz -O ${name}_read-orientation-model.tar.gz
